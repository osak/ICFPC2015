...
VISDUMP_SIMPLE_ALL = visdump-simple/problem_0.json visdump-simple/problem_1.json visdump-simple/problem_2.json visdump-simple/problem_3.json visdump-simple/problem_4.json visdump-simple/problem_5.json visdump-simple/problem_6.json visdump-simple/problem_7.json visdump-simple/problem_8.json visdump-simple/problem_9.json visdump-simple/problem_10.json visdump-simple/problem_11.json visdump-simple/problem_12.json visdump-simple/problem_13.json visdump-simple/problem_15.json visdump-simple/problem_16.json visdump-simple/problem_17.json visdump-simple/problem_18.json visdump-simple/problem_19.json visdump-simple/problem_20.json visdump-simple/problem_21.json visdump-simple/problem_22.json visdump-simple/problem_23.json
